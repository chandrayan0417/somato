		...
		<div className="flex gap-5 flex-wrap justify-between">
			{items.map((item) => {
				...
				return (
					<div
						key={item.id}
						className="h-100 w-70 border border-gray-100 hover:shadow-lg rounded-xl transition-shadow duration-200"
					>
						<div
						...
						<div className="h-[60%] w-full rounded-b-xl p-2 bg-gray-50">
							<div className="flex justify-between items-center pt-3 pb-1">
								...
								<span
									className={`text-lg scale-75 py-1 px-3 rounded-md text-white ${
